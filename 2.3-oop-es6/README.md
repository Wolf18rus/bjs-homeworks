...
решила создать специальный класс _StudentLog_, который бы помог ей удобно вносить
...
1. Передавайте в _конструктор экземпляра_ имя ученика:

```js
const log = new StudentLog("Олег Никифоров");
```

2. Создайте метод _getName_, возвращающее имя ученика:
